...
* ]
*/
function mise_a_jour_fabricant(array $donnees, int $id, ?mysqli $connection = null): array {
    ...
    try {
        ...
        error_log("Erreur MySQL lors de la mise à jour fabricant $id: " . $e->getMessage());
        return [
            'success' => false,
            'affected_rows' => 0,
        ...
        error_log("Erreur lors de la mise à jour fabricant $id: " . $e->getMessage());
        return [
            'success' => false,
            'affected_rows' => 0,
            'error' => $e->getMessage()
