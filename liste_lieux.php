		...
		<main>
						...
						<tr>
							<td rowspan="1">
								<select name="tri">
									...
									<option value="libelle" <?= $sort === 'libelle' ? 'selected' : '' ?>>Nom du lieu</option>
								</select>
							</td>:
						</tr>
					</tbody>
			...
			<form method="post">
				...
				<p align="right">
					...
					<input type="hidden" name="csrf_token" value="<?= $csrf_token ?>" />
					<input type="hidden" name="retour" value="fiche_lieu.php">
					<input type="submit" class="btn btn-primary btn-block" name="submit" value="Afficher le lieu">
				</p>
			</form>
			<form method="post" action="fiche_lieu.php">
				...
				<table>
					<tr>
						...
						<td align="left">
							<input type="submit" name="creation" value="Nouveau lieu" class="btn btn-primary"/>
						</td>
					</tr>
				</table>
			</form>
